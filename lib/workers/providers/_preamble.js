...
const DB_POLICY = [
  ...
  "",
  "Nestes projetos o banco é SEMPRE Supabase (Postgres + Studio + Auth/Storage/Realtime), provisionado pelo Jarvis Hub. NUNCA improvise um banco, NUNCA escreva um adapter de conexão na mão.",
  "",
